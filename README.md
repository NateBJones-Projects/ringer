...
- [@ppkulk-oss](https://github.com/ppkulk-oss) (Prashant Kulkarni; local commits authored as Ringer Local) — invocation provenance, reasoning-effort labels, and registered Grok, Fugu, and Claude lanes (#106)
